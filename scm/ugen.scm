...
(define RBezier
  (lambda (rt haltAfter dx freq phase param)
    (construct-ugen "RBezier" rt (list haltAfter dx freq phase) param 1 nil)))
...
(define RExpRandN
  (lambda (nc lo hi)
    (construct-ugen "RExpRandN" ir (list lo hi) nil nc nil)))
...
(define RRandN
  (lambda (nc lo hi)
    (construct-ugen "RRandN" ir (list lo hi) nil nc nil)))
...
(define RTExpRandN
  (lambda (nc lo hi trigger)
    (construct-ugen "RTExpRandN" (list 2) (list lo hi trigger) nil nc nil)))

(define RTLinRandN
  (lambda (nc lo hi minmax trigger)
    (construct-ugen "RTLinRandN" (list 3) (list lo hi minmax trigger) nil nc nil)))

(define RTRandN
  (lambda (nc lo hi trigger)
    (construct-ugen "RTRandN" (list 2) (list lo hi trigger) nil nc nil)))

(define RTScramble
  (lambda (trigger inputs)
    (construct-ugen "RTScramble" (list 0) (list trigger) inputs 1 nil)))
