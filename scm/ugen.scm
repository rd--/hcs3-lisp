...
(define RDelayMap
  (lambda (bufnum input dynamic mapArray)
    (construct-ugen "RDelayMap" (list 1) (list bufnum input dynamic) mapArray 1 nil)))
...
(define RTExpRandN
  (lambda (numChannels lo hi trigger)
    (construct-ugen "RTExpRandN" (list 2) (list lo hi trigger) nil numChannels nil)))
...
(define RTRandN
  (lambda (numChannels lo hi trigger)
    (construct-ugen "RTRandN" (list 2) (list lo hi trigger) nil numChannels nil)))
